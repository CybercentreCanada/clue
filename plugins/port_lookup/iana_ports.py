...
# from the CSV data) & converts these to a dictionary for lookups for a set of Borealis annotations
...
def _allocation_to_annotation(row: PortAllocation) -> Annotation:
    """Converts the internal PortAllocation structure to a Borealis annotation"""
...
def read_port_annotations() -> dict[int, list[Annotation]]:
    """Builds the in-memory port lookup structure for Borealis in Annotation form."""
